		...
		<div class="container">
			<div class="row">
				...
				<div class="col-6 col-sm-3 offset-sm-1">
					<span><a href="{{url ('/legal/avisolegal') }}">Aviso legal</a></span>
					<span><a href="{{url ('/legal/accesibilidad') }}">Accesibilidad</a></span>
					<span><a href="{{url ('/legal/cookies') }}">Cookies</a></span>
				</div>
